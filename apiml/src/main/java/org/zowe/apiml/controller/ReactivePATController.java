...
public class ReactivePATController {
    ...
    @Operation(summary = "Authenticate mainframe credentials and return personal access token.", tags = { "Access token" }, operationId = "access-token-generate-POST", description = """
        ...
        """, requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(content = @Content(schema = @Schema(implementation = AccessTokenRequest.class)), description = "Specifies the parameters of the requested personal access token."))
    @ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Authenticated - Personal Access Token created"), @ApiResponse(responseCode = "401", description = "Invalid credentials") })
    ...
    @Operation(summary = "Remove invalidated tokens and rules which are not relevant anymore.", tags = { "Access token" }, description = """
        ...
        """, operationId = "accessTokensInvalidateAdminScopeDELETE", security = { @SecurityRequirement(name = "Bearer"), @SecurityRequirement(name = "CookieAuth"), @SecurityRequirement(name = "LoginBasicAuth"), @SecurityRequirement(name = "ClientCert") })
    ...
    @Operation(summary = "Validate personal access token.", tags = { "Access token" }, operationId = "accessTokenValidatePOST", description = """
            Use the `/access-token/validate` API to verify that personal access token is valid.
        
                **Response:**
        
            The response is a plain text body.
        """, requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(content = @Content(schema = @Schema(implementation = ValidateRequestModel.class)), description = "Specifies the personal access token and service ID for validation."))
    ...
    @Operation(summary = "Invalidate multiple personal access tokens.", tags = { "Access token" }, operationId = "accessTokensInvalidateDELETE", description = """
            Use the `/access-token/revoke/token` API to invalidate multiple personal access tokens issued for your user ID.
              ...
              **Response:**
              ...
              The response is no content.
        """, security = { @SecurityRequirement(name = "Bearer"), @SecurityRequirement(name = "CookieAuth"), @SecurityRequirement(name = "ClientCert") }, requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(content = @Content(schemaProperties = { @SchemaProperty(name = "timestamp", schema = @Schema(type = "number")) }), description = "Specifies the time until which the tokens will remain invalid."))
    ...
    @Operation(summary = "Invalidate personal access token.", tags = { "Access token" }, operationId = "accessTokenInvalidateDELETE", description = """
            Use the `/access-token/revoke` API to invalidate a specific personal access token.
        
                **Response:**
        
            The response is no content.
        """, requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(content = @Content(schemaProperties = { @SchemaProperty(name = TOKEN_KEY, schema = @Schema(type = "string")) }), description = "Specifies the personal access token."))
    @ApiResponses(value = { @ApiResponse(responseCode = "204", description = "Successfully revoked"), @ApiResponse(responseCode = "400", description = "Missing or invalid token"), @ApiResponse(responseCode = "401", description = "Invalid token"), @ApiResponse(responseCode = "503", description = "Token invalidation failed") })
    ...
    @Operation(summary = "Invalidate personal access tokens by user ID.", tags = { "Access token" }, operationId = "accessTokensInvalidateAdminDELETE", description = """
            ...
            The response is no content.
        """, security = { @SecurityRequirement(name = "Bearer"), @SecurityRequirement(name = "CookieAuth"), @SecurityRequirement(name = "LoginBasicAuth"), @SecurityRequirement(name = "ClientCert") }, requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(content = @Content(schemaProperties = { @SchemaProperty(name = "user", schema = @Schema(type = "string")), @SchemaProperty(name = "timestamp", schema = @Schema(type = "number")) }), description = "Specifies the user ID and time until which the tokens will remain invalid."))
    @ApiResponses(value = { @ApiResponse(responseCode = "204", description = "Successfully revoked") })
    ...
    @PreAuthorize("@safMethodSecurityExpressionRoot.hasSafServiceResourceAccess('SERVICES', 'READ',#root)")
    @Operation(summary = "Invalidate multiple personal access tokens by service ID.", tags = { "Access token" }, operationId = "accessTokensInvalidateAdminScopeDELETE", description = """
            ...
            The response is no content.
        """, security = { @SecurityRequirement(name = "Bearer"), @SecurityRequirement(name = "CookieAuth"), @SecurityRequirement(name = "LoginBasicAuth"), @SecurityRequirement(name = "ClientCert") }, requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(content = @Content(schemaProperties = { @SchemaProperty(name = "serviceId", schema = @Schema(type = "string")), @SchemaProperty(name = "timestamp", schema = @Schema(type = "number")) }), description = "Specifies the service ID and time until which the tokens will remain invalid."))
    @ApiResponses(value = { @ApiResponse(responseCode = "204", description = "Successfully revoked") })
