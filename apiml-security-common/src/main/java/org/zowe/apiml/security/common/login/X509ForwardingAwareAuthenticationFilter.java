...
public class X509ForwardingAwareAuthenticationFilter extends NonCompulsoryAuthenticationProcessingFilter {
    ...
    public X509ForwardingAwareAuthenticationFilter(String endpoint, AuthenticationSuccessHandler successHandler, AuthenticationProvider authenticationProvider) {
        super(endpoint);
