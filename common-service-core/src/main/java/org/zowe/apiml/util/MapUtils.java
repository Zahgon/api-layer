...
public class MapUtils {
    ...
    static {
        ...
        ACTION_MAP.put(Object[].class, argument -> {
            throw new IllegalArgumentException("Array parsing is not supported");
        });
        ACTION_MAP.put(Object.class, argument -> {
            throw new IllegalArgumentException(String.format("Cannot parse key: %s with value %s", argument.getEntry().getKey(), argument.getEntry().getValue().toString()));
        });
    }
