...
public class PassTicketTestController {
    ...
    public void passticketTest(@RequestHeader("authorization") String authorization, @RequestHeader(value = "X-Zowe-Auth-Failure", required = false) String zoweAuthFailure, @RequestParam(value = "applId", defaultValue = "", required = false) String applId) throws PassTicketException {
